...
<div class="ui attached stackable menu">
    <div class="ui container">
        <a class="item" href="${contextPath}/home/show">
...
<c:forEach items="${value.commands}" var="value2">
  ...
  <tbody>
    <tr>
      <td >${value2}</td>
      <td ><i class="arrow alternate circle right large icon"></i></td>
      <td ><i class="trash alternate large icon"></i></td>
